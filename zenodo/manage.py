...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  First time:\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --init\n\n"
            "  Iterate after editing zenodo/metadata.json locally:\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --sync\n\n"
            "  Only update metadata:\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --metadata\n\n"
            "  Compare local and remote metadata:\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --check-metadata\n\n"
            "  Print remote.record.metadata (full representation used for alignment):\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --print-remote-metadata\n\n"
            "  Print remote.record_simple.metadata (simplified representation):\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --print-remote-metadata-simple\n\n"
            "  Pull UI changes back to local zenodo/metadata.json:\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --pull-metadata\n\n"
            "  Publish after manual review:\n"
            "    ZENODO_TOKEN=... python zenodo/manage.py --publish"
        ),
    )
...
def main() -> int:
    ...
    # Keep defaults anchored to repository root regardless of invocation cwd.
    ...
    dist_dir = resolve_repo_path(args.dist_dir)
    remote_file = resolve_repo_path(args.remote_file)
